...
const CreateBoardModal: React.FC<DraftBoardDialogProps> = ({
    open,
    onClose,
}) => {
    ...
    const handleCreate = (
        ...
        setBoards([
            ...boards,
            { ...initialBoard, Name: newBoardName, Players: cleanedPlayers },
        ]);
    ...
    return (
        <Dialog
            ...
            aria-labelledby="draft-board-dialog-title"
        >
            <DialogTitle id="draft-board-dialog-title">
